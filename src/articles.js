window.eyVisuals = {
  ...
  "03": {
    src: "assets/figures/visual-03.jpg",
    alt: "팬의 공개 활동에서 위험 활동을 분리하고 현재 대화의 최소 근거만 남기는 흐름도"
  },
  "04": {
...
window.eyArticles = [
  ...
  {
    slug: "prombank",
    tags: ["생성형 AI", "프롬프트", "5개월 운영", "422개"],
    title: "422개의 프롬프트 템플릿을 운영한 공유 플랫폼 프롬뱅크",
    excerpt: "생성형 AI에 대한 관심을 개인적인 사용에서 멈추지 않고 프롬프트 공유 플랫폼을 제작해 5개월간 운영했습니다. 422개의 템플릿을 축적하며 재사용 가능한 AI 활용 자료의 조건을 고민했습니다.",
    date: "2026. 07. 20",
    period: "2024.09 ~ 2025.01",
    summary: {
      project: "목적별 생성형 AI 프롬프트를 공유하는 개인 서비스 프롬뱅크",
      problem: "한 번 잘 작동한 프롬프트도 사용 상황과 바꿔 넣을 정보를 알 수 없으면 다른 사람이 재사용하기 어려웠습니다.",
      response: "공유 플랫폼을 직접 제작·운영하며 5개월 동안 422개의 프롬프트 템플릿을 축적했습니다. 이를 바탕으로 재사용 가능한 템플릿의 구조와 운영 기준을 발전시켰습니다.",
      sections: [
        { heading: "개인적인 관심을 서비스로", paragraphs: ["흩어진 프롬프트를 목적에 맞게 찾고 필요한 부분을 바꿔 다시 실행할 수 있는 공간을 직접 만들었습니다. 2024년 9월부터 2025년 1월까지 콘텐츠를 지속적으로 운영했습니다."] },
        { heading: "운영 경험을 다음 설계로", paragraphs: ["422개 템플릿을 축적하며 많이 모으는 것과 다시 쓰기 좋게 관리하는 것이 다르다는 점을 배웠습니다. 이후 목적·입력 변수·출력 형식과 검토 책임을 구분하는 구조로 발전시켰습니다."] }
      ]
    },
    characterCount: "2,214",
    readTime: "4분",
    highlights: ["목적에 맞게 찾고 필요한 부분을 바꿔 다시 실행", "5개월 동안 422개의 프롬프트 템플릿"],
  ...
  },
  {
    ...
    characterCount: "4,325",
    readTime: "6분",
    highlights: ["자동 생성보다 검토와 복구가 가능한 상태", "통제·복구 가능한 End-to-end Workflow"],
    annotations: [["비동기 렌더", "웹 요청과 무거운 영상 편집을 분리해 외부 워커가 작업을 가져가고 상태를 다시 기록하는 방식입니다."]],
    caseNumber: "09",
